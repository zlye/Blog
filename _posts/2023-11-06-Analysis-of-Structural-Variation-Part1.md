...
![1Utagawa Hiroshige 1855 Japan, National Museum of Asian art]({{ site.baseurl }}/assets/images/hiroHI_blog.jpg "an image title")
...
![3an image alt text]({{ site.baseurl }}/assets/images/hiroHI_edit.jpeg "an image title")
...
![Geographic origin of study samples] ({{ site.baseurl }}/assets/images/samplemap4a_edit.png 'an image title')
...
![Distibution of Structural variant sizes]({{site.baseurl}}/assets/images/SV_Size_dist_edit.jpg)
...
We can divide the entire genome into different _functional classes_:
 ...
 -**Intron:** parts of genes that do not code for 
proteins,
...
![Proportion of Structural variants overlappinh each genomic class]({{site.baseurl}}/assets/images/Fractions_edit2.jpg)

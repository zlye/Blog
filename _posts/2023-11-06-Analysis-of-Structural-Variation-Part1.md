...
{% include figure image_path="/images/samplemap4a_edit.pdf" caption="Geographic origin of study samples" %}
...
{% include figure image_path="/images/SV_Size_dist_edit.pdf"%}
...
{% include figure image_path="/images/Fractions_edit2.pdf" %}
...
{% include figure image_path="/images/SV_overlap_enrichment_sim_result.pdf" alt="caption" caption="caption" %}
